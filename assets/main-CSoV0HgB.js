(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const s of t.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function a(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=a(e);fetch(e.href,t)}})();const n="/sdc-vite/SDC%20Logo.png",l=document.querySelector("title");l.innerText="SDC - Database";const d=document.querySelector("header");d.innerHTML=`  <div class="contact-details">
    ...
    <div class="logo">
        <img src="${n}" onclick="location.href = 'https://nh-nahid.github.io/sdc-vite/'" alt="Not responding">
...
`;document.querySelector(".person-title").style.textAlign="center";const u=document.querySelectorAll(".modal"),p=document.querySelectorAll(".fa-x"),c=document.querySelector("#modal");u.forEach(function(o){o.addEventListener("click",function(){c.classList.add("modal-open")})});p.forEach(function(o){o.addEventListener("click",function(){c.classList.remove("modal-open")})});
